...
extension Notification.Name {
    ...
    static let didChangedMuseumRequestDate = Notification.Name("didChangedMuseumRequestDate")
    static let didChangedMuseumRequestType = Notification.Name("didChangedMuseumRequestType")
